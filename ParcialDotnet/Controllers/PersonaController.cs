...
namespace WebPulsaciones.Controllers
{
    ...
    public class PersonaController : ControllerBase
    {
        ...
        {
            var personas = _personaService.ConsultarTodos().Select(p => new PersonaViewModel(p, _apoyoService.ConsultarByPersona(p.Identificacion)));
            return personas;
        }
        ...
        public ActionResult<PersonaViewModel> Get(string identificacion)
        {
            ...
            var personaViewModel = new PersonaViewModel(persona, _apoyoService.ConsultarByPersona(identificacion));
